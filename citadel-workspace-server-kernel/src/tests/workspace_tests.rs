...
fn test_permissions_inheritance() {
    ...
    let member_office_perm =
        kernel.check_entity_permission(member_id, &office_id, Permission::ViewContent);
    ...
    let member_room_perm =
        kernel.check_entity_permission(member_id, &room_id, Permission::ViewContent);
    ...
    let member_edit_perm =
        kernel.check_entity_permission(member_id, &room_id, Permission::EditContent);
    ...
    let owner_edit_room =
        kernel.check_entity_permission(owner_id, &room_id, Permission::EditContent);
    ...
    let admin_edit_room =
        kernel.check_entity_permission(admin_id, &room_id, Permission::EditContent);
