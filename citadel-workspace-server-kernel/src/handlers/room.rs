...
impl<R: Ratchet> WorkspaceServerKernel<R> {
    ...
    pub fn create_room(
        ...
        self.domain_operations.create_domain_entity::<Room>(user_id, Some(office_id), name, description, mdx_content)
    }

    /// Delete a room
    pub fn delete_room(&self, user_id: &str, room_id: &str) -> Result<Room, NetworkError> {
        self.domain_operations.delete_domain_entity::<Room>(user_id, room_id)
    }
    ...
    pub fn update_room(
        ...
        self.domain_operations.update_domain_entity::<Room>(user_id, room_id, name, description, mdx_content)
    }

    /// Get a room by ID
    pub fn get_room(&self, user_id: &str, room_id: &str) -> Result<Room, NetworkError> {
        // Use the domain abstraction for getting a room
        self.domain_operations.get_domain_entity::<Room>(user_id, room_id)
    }
    ...
    pub fn list_rooms(&self, user_id: &str, office_id: &str) -> Result<Vec<Room>, NetworkError> {
        ...
        self.domain_operations.list_domain_entities::<Room>(user_id, Some(office_id))
    }
    ...
    pub fn list_all_rooms(&self, user_id: &str) -> Result<Vec<Room>, NetworkError> {
        ...
        self.domain_operations.list_domain_entities::<Room>(user_id, None)
    }
}
