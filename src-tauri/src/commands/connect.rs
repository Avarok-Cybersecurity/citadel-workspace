...
pub async fn connect(
    ...
    let crypto_params = CryptoParameters {
        encryption_algorithm: EncryptionAlgorithm::from_u8(registration_info.encryption_algorithm).unwrap(),
    ...
    let payload = Connect {
        ...
        server_password: registration_info.server_password.map(|pass| pass.into_bytes().into()),
    };
