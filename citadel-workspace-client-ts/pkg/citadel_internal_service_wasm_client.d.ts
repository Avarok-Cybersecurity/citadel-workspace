...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__hcb276ed5a66c764a: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h968876f9daa86614: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hdf5e65de09412ac5: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__ha12fde1bb25c46b1: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h10ef8c18e087d6ee: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__hc929a81066918af1: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__hb9de5abb9c633eef: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__hd46220dca824cea7: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h7af0fdeabf4da7a7: (a: number, b: number, c: any, d: any) => void;
