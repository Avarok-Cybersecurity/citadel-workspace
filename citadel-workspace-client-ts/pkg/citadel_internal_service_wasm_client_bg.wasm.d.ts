...
export const closure455_externref_shim: (a: number, b: number, c: any) => void;
export const closure289_externref_shim: (a: number, b: number, c: any) => void;
export const closure392_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hc63dd2899c88060c: (a: number, b: number) => void;
