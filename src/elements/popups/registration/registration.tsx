...
function Step1(props: {
  ...
  const [workspaceIdentifier, setWorkspaceIdentifier] = useState<string>(
    props.registrationRequest.workspaceIdentifier || "127.0.0.1:12349",
  ); // Address for debugging
  const [workspacePassword, setWorkspacePassword] = useState<string>(
    props.registrationRequest.workspacePassword || "",
  );
    ...
    <>
      ...
      <div className="input-icon-pair">
        <input
          ...
          onChange={(ev) => {
            setWorkspaceIdentifier(ev.target.value);
          }}
        />
      ...
      <div className="input-icon-pair">
        <input
          ...
          onChange={(ev) => {
            setWorkspacePassword(ev.target.value);
          }}
        />
        <i className="bi bi-question-circle"></i>
      </div>
...
function Step2(props: {
  ...
  const [securityLevel, setSecurityLevel] = useState<number>(
    props.registrationRequest.securityLevel || 0,
  );
  const [securityMode, setSecurityMode] = useState<number>(
    props.registrationRequest.securityMode || 0,
  );
  const [encryptionAlgorithm, setEncryptionAlgorithm] = useState<number>(
    props.registrationRequest.encryptionAlgorithm || 0,
  );
  const [kemAlgorithm, setKemAlgorithm] = useState<number>(
    props.registrationRequest.kemAlgorithm || 0,
  );
  const [sigAlgorithm, setSigAlgorithm] = useState<number>(
    props.registrationRequest.sigAlgorithm || 0,
  );
    ...
    <>
      ...
      <div className="input-icon-pair">
        <Select
          ...
          value={securityLevels.find(
            (option) => option.value === securityLevel,
          )}
          onChange={(ev) => {
            setSecurityLevel(ev?.value || securityLevel);
          }}
          unstyled
        />
        <i className="bi bi-question-circle"></i>
      ...
      <div className="input-icon-pair">
        <Select
          ...
          onChange={(ev) => {
            setSecurityMode(ev?.value || securityMode);
          }}
          unstyled
        />
        <i className="bi bi-question-circle"></i>
      ...
      <div
        ...
        style={{ display: advancedMode ? "block" : "none" }}
      >
        ...
        <div className="input-icon-pair">
          <Select
            ...
            value={encryptionOptions.find(
              (option) => option.value === encryptionAlgorithm,
            )}
            onChange={(ev) => {
              setEncryptionAlgorithm(ev?.value || encryptionAlgorithm);
            }}
            unstyled
          />
          <i className="bi bi-question-circle"></i>
        ...
        <div className="input-icon-pair">
          <Select
            ...
            onChange={(ev) => {
              setKemAlgorithm(ev?.value || kemAlgorithm);
            }}
            unstyled
          />
          <i className="bi bi-question-circle"></i>
        ...
        <div className="input-icon-pair">
          <Select
            ...
            onChange={(ev) => {
              setSigAlgorithm(ev?.value || sigAlgorithm);
            }}
            unstyled
          />
          <i className="bi bi-question-circle"></i>
...
function Step3(props: {
  ...
  const [fullName, setFullName] = useState<string>(
    props.registrationRequest.fullName || "",
  );
  const [username, setUsername] = useState<string>(
    props.registrationRequest.username || "",
  );
  const [profilePassword, setProfilePassword] = useState<string>(
    props.registrationRequest.profilePassword || "",
  );
  const [profilePasswordConfirmation, setProfilePasswordConfirmation] =
    useState<string>(props.registrationRequest.profilePassword || "");
    ...
    <>
      ...
      <div className="input-icon-pair">
        <input
          ...
          onChange={(ev) => {
            setProfilePassword(ev.target.value);
          }}
        />
        <i className="bi bi-question-circle"></i>
      </div>
      ...
      <div className="input-icon-pair">
        <input
          ...
          onChange={(ev) => {
            setProfilePasswordConfirmation(ev.target.value);
          }}
          onClick={() => {
            if (profilePasswordConfirmation !== profilePassword) {
...
function Step4(props: {
  ...
  return (
    <>
      ...
      <p className="console" style={{ color: success ? "white" : "#f1707c" }}>
        {message}
      </p>
