...
import "./home.css";
import { PeerInformation, RegistrationInfo, WorkspaceInfo } from "../../../api/types";
import { useEffect, useState } from "react";
import { connect, getDefaultWorkspace, list_all_peers } from "../../../api/util";
...
export default function Home() {
  ...
  const [allPeers, setAllPeers] = useState<Record<string, PeerInformation>|null>(null);
  ...
  useEffect(()=>{
    ...
    async function setup(){
      ...
      if (connection_response.success && connection_response.cid !== null){
        ...
        console.error("Failed to connect to server.", connection_response.message);
        return
      }
