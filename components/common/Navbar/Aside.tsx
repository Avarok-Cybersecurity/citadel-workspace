    ...
    <div className="">
      ...
      <div className="flex">
        {true ? (
          <aside
            id="logo-sidebar"
            className="flex fixed top-0 left-16 z-40 w-64 h-screen pt-[65px] transition-transform -translate-x-[130%] border-r sm:translate-x-0 bg-gray-800 border-gray-700"
            aria-label="Sidebar"
          >
